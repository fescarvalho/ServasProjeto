export type LiturgicalColor = "roxo" | "verde" | "branco" | "vermelho" | "rosa";
...
export const LITURGICAL_DATA_2026: Record<string, DayData> = {
    ...
    "01-26": {
        ...
        history: "Discípulos e colaboradores próximos de São Paulo. Timóteo foi bispo de Éfeso e Tito de Creta, exemplos de pastores fiéis que ajudaram a estruturar as primeiras churches."
    },
    ...
    "06-11": {
        ...
        history: "Discípulo e colaborador próximo de São Paulo. Timóteo foi bispo de Éfeso e Tito de Creta, exemplos de pastores fiéis que ajudaram a estruturar as primeiras churches."
    },
    "06-12": {
...
export function getLiturgicalData(date: Date): DayData {
    const key = getDateKey(date);
    return LITURGICAL_DATA_2026[key] ?? { season: "Tempo Comum", color: "verde" };
}
